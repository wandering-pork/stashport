    ...
    try {
      ...
      setTimeout(() => {
        if (document.visibilityState === 'visible') {
          setError('Unable to open login page. Please check if popups are blocked.')
          setIsOAuthLoading(null)
        }
      }, 3000)
    } catch (err) {
        ...
        <div className="w-full max-w-md relative z-10 animate-slide-in-up">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-full h-14 rounded-2xl border border-[#ebe4d6] bg-white flex items-center justify-center gap-3 transition-all duration-300 hover:border-[#d9cfc0] hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:scale-[1.01] active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed"
            ...
            >
              {isOAuthLoading === 'google' ? (
                ...
                <>
                  ...
                  <span className="text-[#5d5a54] font-medium">Continue with Google</span>
                </>
              )}
            </button>
          </div>
